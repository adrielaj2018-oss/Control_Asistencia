      ...
      <div class="page-card">
        ...
        {% for h in hojas %}
          <div class="swipe-wrap">
            ...
            <a class="text-decoration-none" href="{{url_for('detalle_hoja', hoja_id=h.id, tab='trabajadores')}}"><div class="worker-card">
...
def crear_hoja():
    if request.method == 'POST':
        ...
        return redirect(url_for('detalle_hoja', hoja_id=hid, tab='trabajadores'))
