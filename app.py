...
<style>
/* === PATCH 249 FINAL CELULAR: ancho tipo app, horario estable y tarjetas compactas === */
.shell{padding:6px!important}.phone-wrap{max-width:390px!important;margin:0 auto!important}.page-card{max-width:390px!important;margin:0 auto!important;border-radius:12px!important}.header-title{font-size:18px!important;line-height:1.05!important;margin:8px 4px 10px!important}.green-hero,.panel-green{padding-top:12px!important;padding-bottom:30px!important}.toolstrip{margin:-23px 8px 5px!important;min-height:38px!important;padding:5px 12px!important;gap:16px!important}.toolstrip button,.toolstrip a{font-size:21px!important}.info-bar{margin:0 8px!important;height:22px!important;font-size:9px!important}.tab-main a{font-size:11px!important;padding:10px 5px!important}.subtabs a{font-size:10px!important;padding:9px 4px!important}.trabajador-card-ref{margin:5px 6px!important;padding:7px 9px!important;border-radius:10px!important;border-width:2px!important}.trabajador-card-ref .worker-title{font-size:7.5px!important;gap:6px!important}.trabajador-card-ref .worker-title b{font-size:10.5px!important;line-height:1.1!important}.trabajador-grid-ref{grid-template-columns:repeat(3,1fr)!important;gap:5px 5px!important;margin-top:7px!important}.trabajador-grid-ref label{font-size:7px!important;margin-bottom:2px!important}.trabajador-grid-ref .time-box,.trabajador-grid-ref .metric-box{height:25px!important;font-size:10.5px!important;padding:2px 4px!important;justify-content:center!important;text-align:center!important}.trabajador-grid-ref .metric-box{font-size:12px!important;font-weight:900!important}.trabajador-grid-ref .mini-badge{height:28px!important;font-size:9px!important}.avance-card-ref{margin:5px 8px!important;padding:8px 10px!important}.avance-card-ref .worker-title b{font-size:11px!important}.labor-card-compact{margin:7px 9px!important;padding:9px 11px!important}.labor-card-compact .labor-main{font-size:14px!important}.labor-card-compact .resp-main{font-size:12px!important}.leaf{width:82px!important;height:82px!important;margin-top:12px!important}.modal-dialog{max-width:360px!important;margin:.55rem auto!important}.modal-header{padding:8px 12px!important}.modal-body{padding:10px 12px!important}.modal-footer{padding:9px 12px!important}.modal .form-control,.modal .form-select{height:36px!important;font-size:12px!important}.touch-clock-panel{padding:7px!important}.time-display{height:33px!important;font-size:20px!important}.time-slider{height:34px!important}.time-slider::-webkit-slider-thumb{width:32px!important;height:32px!important;margin-top:-13px!important}.edit-action-menu{position:absolute;right:10px;bottom:8px}.btn-card-action{border:0;background:transparent;color:#0b7a3b;font-weight:900;font-size:14px;padding:2px 5px}.card-menu-pop{position:absolute;right:4px;bottom:24px;background:#fff;border-radius:10px;box-shadow:0 9px 24px rgba(0,0,0,.18);border:1px solid #dfe7df;display:none;z-index:20;min-width:105px;overflow:hidden}.card-menu-pop a,.card-menu-pop button{display:block;width:100%;padding:9px 12px;border:0;background:#fff;text-align:left;font-weight:900;font-size:12px;text-decoration:none;color:#146c35}.card-menu-pop a.text-danger,.card-menu-pop button.text-danger{color:#b42318!important}.edit-action-menu.show .card-menu-pop{display:block}
@media(max-width:410px){.phone-wrap,.page-card{max-width:100%!important}.shell{padding:0!important}.trabajador-card-ref{margin:4px 5px!important}.modal-dialog{max-width:94%!important}}

/* === PATCH 250: ancho angosto estilo app/celular y registros más encajaditos === */
html,body{background:#3b3b3b!important}.app-bg{max-width:315px!important;min-height:100vh!important;margin:0 auto!important;background:#fff!important;overflow-x:hidden!important}.shell{width:315px!important;max-width:315px!important;padding:6px!important;margin:0 auto!important}.phone-wrap,.page-card{width:100%!important;max-width:303px!important;margin:0 auto!important}.header-title{font-size:15px!important;line-height:1.05!important;margin:7px 3px 8px!important}.green-hero,.panel-green{padding:10px 8px 26px!important;min-height:106px!important}.panel-green i{font-size:28px!important}.panel-green h4{font-size:9px!important}.tab-main a{font-size:10px!important;padding:9px 3px!important}.subtabs a{font-size:9px!important;padding:8px 3px!important}.toolstrip{min-height:34px!important;margin:-19px 6px 4px!important;padding:4px 9px!important;gap:13px!important}.toolstrip button,.toolstrip a{font-size:19px!important}.info-bar{margin:0 6px!important;height:20px!important;font-size:8px!important}.worker-card,.labor-card-compact,.trabajador-card-ref,.avance-card-ref{margin:5px 6px!important;border-radius:9px!important;box-shadow:0 4px 12px rgba(0,0,0,.12)!important}.trabajador-card-ref{padding:6px 8px!important}.trabajador-card-ref .worker-title{font-size:7px!important}.trabajador-card-ref .worker-title b{font-size:10px!important}.trabajador-grid-ref{gap:5px!important;margin-top:6px!important}.trabajador-grid-ref label{font-size:6.7px!important}.trabajador-grid-ref .time-box,.trabajador-grid-ref .metric-box{height:24px!important;font-size:10px!important}.trabajador-grid-ref .metric-box{font-size:11.5px!important}.labor-card-compact{padding:8px 9px!important}.labor-card-compact .labor-main{font-size:12px!important}.labor-card-compact .resp-main{font-size:10.5px!important}.modal-dialog{max-width:295px!important;margin:.5rem auto!important}.modal-title{font-size:15px!important}.modal .form-control,.modal .form-select{height:34px!important;font-size:11.5px!important}.btn-green{height:38px!important;font-size:13px!important}.leaf{width:70px!important;height:70px!important;margin-top:10px!important}.avance-card-ref{padding:7px 8px!important}.avance-card-ref .worker-title b{font-size:10px!important}.worker-queue{max-height:145px!important;padding:6px!important}.queue-item{font-size:10.5px!important;padding:5px 0!important}

</style>
<script>
/* === PATCH 249 FINAL V2: horario estable + avance en cola hasta Guardar Final === */
(function(){
 const $=id=>document.getElementById(id);
 ...
 function toTime(m){m=Math.max(0,Math.min(1435,Math.round(Number(m||0)/5)*5)); return pad(Math.floor(m/60))+':'+pad(m%60);}
 function onlyDni(v){let d=String(v||'').replace(/\D/g,''); return d.length>=8?d.slice(-8):d;}
 function clone(id){let e=$(id); if(e&&e.parentNode){let n=e.cloneNode(true); e.parentNode.replaceChild(n,e); return n;} return e;}
 let active='horaInicioDefault';
 function syncHidden(){[['horaInicioTrab','horaInicioDefault'],['horaFinTrab','horaFinDefault'],['refInicioTrab','refInicioDefault'],['refFinTrab','refFinDefault']].forEach(([h,i])=>{let he=$(h),ie=$(i); if(he&&ie)he.value=ie.value;});}
 function repaint(){IDS.forEach(id=>{let e=$(id); if(e)e.classList.toggle('border-success',id===active);}); let sl=$('timeSlider24'), tv=$('touchClockValue'), e=$(active); if(e){if(tv)tv.textContent=e.value||'00:00'; if(sl)sl.value=toMin(e.value);} let box=$('clockPickFields'); if(box)box.querySelectorAll('button').forEach(b=>b.classList.toggle('active',b.dataset.target===active)); syncHidden();}
 function setActive(id){if(IDS.includes(id)){active=id; repaint();}}
 function setTime(v){let e=$(active); if(!e)return; e.value=toTime(v); repaint();}
 function bindHorarioFinal(){
   IDS.forEach(id=>{let e=clone(id); if(!e)return; e.readOnly=false; e.inputMode='numeric'; e.maxLength=5; ['focus','pointerdown','click'].forEach(ev=>e.addEventListener(ev,()=>setActive(id))); e.addEventListener('input',()=>{let v=e.value.replace(/[^0-9:]/g,''); if(/^\d{3,4}$/.test(v)){v=v.padStart(4,'0').replace(/^(\d{2})(\d{2})$/,'$1:$2');} e.value=v.slice(0,5); if(/^([01]?\d|2[0-3]):[0-5]\d$/.test(e.value))repaint();});});
   let pills=$('clockPickFields'); if(pills)pills.querySelectorAll('button').forEach(b=>{let nb=b.cloneNode(true); b.parentNode.replaceChild(nb,b); ['click','pointerdown'].forEach(ev=>nb.addEventListener(ev,e=>{e.preventDefault();e.stopPropagation();setActive(nb.dataset.target);}));});
   let sl=clone('timeSlider24'); if(sl){sl.style.touchAction='none'; const calc=ev=>{let r=sl.getBoundingClientRect(); let x=(ev.touches&&ev.touches[0]?ev.touches[0].clientX:ev.clientX); if(typeof x==='number'&&r.width){let pct=Math.max(0,Math.min(1,(x-r.left)/r.width)); setTime(pct*1435);}else setTime(sl.value);}; ['input','change','click','pointerdown','pointermove','touchstart','touchmove'].forEach(ev=>sl.addEventListener(ev,e=>{if(ev.includes('move')&&!(e.buttons||e.touches))return; e.preventDefault&&e.preventDefault(); calc(e);},{passive:false}));}
   repaint();
 }
 const avanceQueue=[];
 function renderAvanceQueue(){let q=$('avanceQueue'), hd=$('dnisAvanceBatch'), hc=$('cantidadesAvanceBatch'); if(!q)return; if(hd)hd.value=avanceQueue.map(x=>x.dni).join(','); if(hc)hc.value=avanceQueue.map(x=>x.cantidad).join(','); if(!avanceQueue.length){q.innerHTML='<div class="text-muted small text-center">Aún no hay avances cargados.</div>';return;} q.innerHTML=avanceQueue.map((x,i)=>'<div class="queue-item"><div><b>'+x.dni+'</b><br><span>'+x.nombre+'</span></div><div class="text-end"><b>'+Number(x.cantidad).toFixed(2)+'</b><br><button type="button" class="btn btn-sm btn-outline-danger" onclick="window.avanceQueueRemove('+i+')">×</button></div></div>').join('');}
 window.avanceQueueRemove=function(i){avanceQueue.splice(i,1); renderAvanceQueue();};
 function parseCantidad(){let c=$('codigoAvance'), q=$('cantidadAvance'), box=$('cantidadDetectada'); if(!q)return Number(1).toFixed(2); let val=q.value||'1.00'; if(c&&c.value.trim()){let m=String(c.value).match(/(\d+(?:[\.,]\d+)?)(?!.*\d)/); if(m)val=m[1].replace(',','.');} let n=Number(val); if(!isFinite(n)||n<=0)n=1; q.value=n.toFixed(2); if(box){box.style.display='block';box.innerHTML='Cantidad a registrar: <b>'+q.value+'</b>';} return q.value;}
 async function validarTrabAvance(){let inp=$('dniAvance'), lab=$('avanceLaborId'), st=$('avanceTrabStatus'); if(!inp||!lab)return null; let d=onlyDni(inp.value); inp.value=d; if(d.length<8){if(st){st.className='field-help mt-2';st.innerHTML='Debe estar registrado en Trabajadores de esta labor.';}return null;} try{let m=(($('frmAvance')||{}).action||'').match(/\/hoja\/(\d+)\//); let hoja=m?m[1]:''; let r=await fetch('/api/trabajador-labor/'+hoja+'/'+lab.value+'/'+d,{cache:'no-store',credentials:'same-origin'}); let j=await r.json(); if(j.ok){if(st){st.className='scan-ok mt-2';st.innerHTML='✓ Trabajador registrado en esta labor: <b>'+j.trabajador.trabajador+'</b>';} return {dni:d,nombre:j.trabajador.trabajador||'TRABAJADOR'};} if(st){st.className='scan-bad mt-2';st.innerHTML='✕ '+(j.msg||'Trabajador no registrado en esta labor.');} return null;}catch(e){if(st){st.className='scan-bad mt-2';st.innerHTML='No se pudo validar trabajador.';}return null;}}
 async function agregarAvanceActual(){let t=await validarTrabAvance(); if(!t)return false; let cantidad=parseCantidad(); avanceQueue.push({dni:t.dni,nombre:t.nombre,cantidad:cantidad}); renderAvanceQueue(); let di=$('dniAvance'), ca=$('codigoAvance'); if(di)di.value=''; if(ca)ca.value=''; let st=$('avanceTrabStatus'); if(st){st.className='scan-ok mt-2';st.innerHTML='✓ Avance agregado al pre-registro. Puedes seguir leyendo o presionar Guardar.';} if(di)setTimeout(()=>di.focus(),80); return true;}
 let addTimer=null;
 document.addEventListener('input',e=>{if(e.target&&e.target.id==='dniAvance'){clearTimeout(addTimer); if(onlyDni(e.target.value).length===8)addTimer=setTimeout(agregarAvanceActual,250);} if(e.target&&e.target.id==='codigoAvance'){parseCantidad(); clearTimeout(addTimer); if(onlyDni(($('dniAvance')||{}).value).length===8)addTimer=setTimeout(agregarAvanceActual,300);}},true);
 document.addEventListener('keydown',e=>{if(e.target&&(e.target.id==='dniAvance'||e.target.id==='codigoAvance')&&e.key==='Enter'){e.preventDefault();agregarAvanceActual();}},true);
 document.addEventListener('submit',async e=>{if(e.target&&e.target.id==='frmAvance'){if(!avanceQueue.length){e.preventDefault(); let ok=await agregarAvanceActual(); if(ok) e.target.submit(); else alert('Agrega al menos un avance válido. El trabajador debe estar registrado en Trabajadores de esta labor.');}else{renderAvanceQueue();}}},true);
 document.addEventListener('shown.bs.modal',e=>{if(e.target&&e.target.id==='modalHora')setTimeout(bindHorarioFinal,30); if(e.target&&e.target.id==='modalAvance'){avanceQueue.length=0; renderAvanceQueue(); setTimeout(()=>{let i=$('dniAvance'); if(i)i.focus();},80);}},true);
 document.addEventListener('click',e=>{document.querySelectorAll('.edit-action-menu.show').forEach(x=>{if(!x.contains(e.target))x.classList.remove('show')});},true);
 window.toggleCardMenu=function(ev,id){ev.stopPropagation();let el=$(id); if(el)el.classList.toggle('show');};
 window.setCampoHorario=setActive; window.aplicarHorarioRegistro=syncHidden;
 setTimeout(bindHorarioFinal,200);
})();
</script>
</body></html>
"""
...
def detalle_hoja(hoja_id):
    ...
    <div class="phone-wrap desktop-pad"><h2 class="header-title">TAREO MÓVIL – {{ 'DETALLE DE TRABAJADOR POR LABOR' if tab=='trabajadores' else ('DETALLE NÚMERO DE LECTURAS POR BALDE' if tab=='rendimiento' else 'GRUPO DE COSECHA') }}</h2>
      <div class="page-card">
        ...
        {% elif tab=='trabajadores' %}
          {% for r in tareos %}<div class="worker-card trabajador-card-ref {{'editable-tareo' if h.estado!='ENVIADA' else ''}}" {% if h.estado!='ENVIADA' %}onclick="abrirEditarTareo('{{r.id}}','{{r.hora_inicio or ('22:00' if r.turno=='NOCHE' else '06:30')}}','{{r.hora_fin or ('06:00' if r.turno=='NOCHE' else '16:30')}}','{{r.ref_inicio or '12:00'}}','{{r.ref_fin or '13:00'}}')"{% endif %}><div class="worker-title"><div>TRABAJADOR<br><b>{{r.trabajador}}</b></div><div>NRO.DOCUMENTO<br><b>{{r.dni}}</b></div></div><div class="trabajador-grid-ref"><div><label>H.INICIO</label><div class="time-box">{{r.hora_inicio or ('22:00' if r.turno=='NOCHE' else '06:30')}}</div></div><div><label>H.FIN</label><div class="time-box">{{r.hora_fin or ('06:00' if r.turno=='NOCHE' else '16:30')}}</div></div><div><label>H.NORMAL</label><div class="metric-box">{{'%.2f'|format((r.horas or 0) - (r.horas_nocturnas or 0))}}</div></div><div><label>REF.INI</label><div class="time-box">{{r.ref_inicio or '12:00'}}</div></div><div><label>REF.FIN</label><div class="time-box">{{r.ref_fin or '13:00'}}</div></div><div><label>H.NOCTURNO</label><div class="metric-box">{{'%.2f'|format(r.horas_nocturnas or 0)}}</div></div><div><label>ESTADO</label><div class="mini-badge bg-g">FIN TOTAL</div></div>{% if h.estado!='ENVIADA' %}<div class="edit-action-menu" id="menuTareo{{r.id}}"><button type="button" class="btn-card-action" onclick="toggleCardMenu(event,'menuTareo{{r.id}}')"><i class="bi bi-chevron-left"></i></button><div class="card-menu-pop"><button type="button" onclick="abrirEditarTareo('{{r.id}}','{{r.hora_inicio or ('22:00' if r.turno=='NOCHE' else '06:30')}}','{{r.hora_fin or ('06:00' if r.turno=='NOCHE' else '16:30')}}','{{r.ref_inicio or '12:00'}}','{{r.ref_fin or '13:00'}}')">Modificar</button><a class="text-danger" href="{{url_for('eliminar_tareo', tareo_id=r.id)}}" onclick="event.stopPropagation();return confirm('¿Eliminar trabajador del tareo?')">Eliminar</a></div></div>{% endif %}</div></div>{% else %}<div class="worker-card text-center text-muted">Presiona el <b>hombresito +</b> para registrar trabajador por QR/código/digitación.</div>{% endfor %}
        {% else %}
          {% for l in lecturas %}<div class="worker-card avance-card-ref"><span class="person-dot"><i class="bi bi-person-circle"></i></span><div class="worker-title"><div>TRABAJADOR<br><b>{{l.trabajador}}</b></div><div>NRO.DOC.<br><b>{{l.dni}}</b></div></div><div class="small-label mt-1">HORA TOMA REGISTRO</div><div class="small-value">{{l.fecha_hora}} · {{l.metodo or 'DIGITACIÓN'}}</div><div class="worker-grid avance-grid"><div><label>CANTIDAD</label><div class="mini-badge bg-y">{{'%.2f'|format(l.a_diurno or 0)}}</div></div><div class="edit-action-menu" id="menuAvance{{l.id}}">{% if h.estado!='ENVIADA' %}<button type="button" class="btn-card-action" onclick="toggleCardMenu(event,'menuAvance{{l.id}}')"><i class="bi bi-chevron-left"></i></button><div class="card-menu-pop"><button type="button" onclick="abrirEditarAvance('{{l.id}}','{{l.a_diurno or 0}}','0')">Modificar</button><a class="text-danger" href="{{url_for('eliminar_lectura', lectura_id=l.id)}}" onclick="return confirm('¿Eliminar avance?')">Eliminar</a></div>{% else %}<i class="bi bi-lock text-muted"></i>{% endif %}</div></div></div>{% else %}<div class="worker-card text-center text-muted">Presiona el icono de escaneo para registrar avance por QR/código/digitación.</div>{% endfor %}
    ...
    <div class="modal fade" id="modalAvance" tabindex="-1"><div class="modal-dialog modal-dialog-centered"><div class="modal-content"><form method="post" action="{{url_for('guardar_registro_hoja', hoja_id=h.id, tab='rendimiento')}}" id="frmAvance"><div class="modal-header"><h5 class="modal-title fw-bold text-success"><i class="bi bi-upc-scan"></i> Registrar avance / lectura</h5><button class="btn-close" data-bs-dismiss="modal"></button></div><div class="modal-body"><div class="scan-box mb-2"><label class="form-label">DNI / QR / CÓDIGO BARRAS DEL TRABAJADOR</label><div class="input-group"><input name="dni" id="dniAvance" class="form-control" placeholder="Escanee o digite DNI" autocomplete="off" inputmode="numeric"><button type="button" class="btn btn-green" onclick="abrirScanner('readerAvance','dniAvance')"><i class="bi bi-upc-scan"></i></button></div><div id="avanceTrabStatus" class="field-help mt-2">Debe estar registrado en Trabajadores de esta labor.</div><div id="readerAvance" style="display:none;margin-top:8px"></div><label class="form-label mt-2">LECTOR AVANCE / QR / CÓDIGO BARRAS</label><div class="input-group"><input name="codigo_avance" id="codigoAvance" class="form-control" placeholder="CÓDIGO AVANCE / BALDE / ETIQUETA / CANTIDAD"><button type="button" class="btn btn-green" onclick="abrirScanner('readerCodigoAvance','codigoAvance')"><i class="bi bi-upc-scan"></i></button></div><div id="readerCodigoAvance" style="display:none;margin-top:8px"></div><div id="cantidadDetectada" class="scan-ok mt-2" style="display:none">Cantidad a registrar: <b>1.00</b></div></div><label class="form-label">LABOR SELECCIONADA</label><input type="hidden" name="labor_id" value="{{selected_labor_id}}" id="avanceLaborId"><input type="hidden" name="dnis_avance" id="dnisAvanceBatch"><input type="hidden" name="cantidades_avance" id="cantidadesAvanceBatch"><div class="form-control mb-2" style="height:auto;min-height:37px;background:#f8fff9;color:#166534;font-weight:900">{% if selected_labor %}{{selected_labor.labor}} / {{selected_labor.turno}} / {{selected_labor.tipo_tareo}}{% else %}PRIMERO SELECCIONA UNA LABOR{% endif %}</div><div class="row g-2"><div class="col-12"><label class="form-label">CANTIDAD A REGISTRAR</label><input name="cantidad" id="cantidadAvance" type="number" step="0.01" class="form-control" value="1.00" required><input name="a_noct" id="aNoctAvance" type="hidden" value="0.00"><div class="field-help">Escanea/digita DNI y cantidad. Se acumula abajo y recién se guarda al presionar GUARDAR AVANCE.</div></div><div class="col-6"><label class="form-label">UNIDAD</label><select name="unidad" class="form-select"><option>BALDE</option><option>KG</option><option>JABA</option><option>UNIDAD</option></select></div><div class="col-6"><label class="form-label">MÉTODO</label><select name="metodo" class="form-select"><option>QR/CÓDIGO</option><option>DIGITACIÓN</option><option>LECTOR USB</option></select></div></div><div class="queue-title mt-2">PRE-REGISTRO DE AVANCES</div><div id="avanceQueue" class="worker-queue"><div class="text-muted small text-center">Aún no hay avances cargados.</div></div></div><div class="modal-footer"><button class="btn btn-green w-100" id="btnGuardarAvance">GUARDAR AVANCE</button></div></form></div></div></div>
    <div class="modal fade" id="modalEditAvance" tabindex="-1"><div class="modal-dialog modal-dialog-centered"><div class="modal-content"><form id="frmEditAvance" method="post"><div class="modal-header"><h5 class="modal-title fw-bold text-success"><i class="bi bi-pencil-square"></i> Editar avance</h5><button class="btn-close" data-bs-dismiss="modal"></button></div><div class="modal-body"><div class="alert alert-light border small">Solo se puede editar si la hoja aún no fue enviada.</div><div class="row g-2"><div class="col-12"><label class="form-label">CANTIDAD</label><input id="editCantAvance" name="cantidad" type="number" step="0.01" class="form-control" required><input id="editNoctAvance" name="a_noct" type="hidden" value="0.00"></div></div></div><div class="modal-footer"><button class="btn btn-green w-100">GUARDAR CAMBIOS</button></div></form></div></div></div>
...
def guardar_registro_hoja(hoja_id, tab):
    ...
    dnis_raw = (request.form.get('dnis_avance') if tab == 'rendimiento' else request.form.get('dnis_masivos')) or request.form.get('dni') or ''
    dnis = []
    ...
    if tab == 'rendimiento':
        # En Rend./Avance solo se permite registrar si el DNI ya existe en Trabajadores de la misma labor.
        # En Rend./Avance se permite acumular varios trabajadores/lecturas en cola y guardar al final.
        # Cada DNI se valida dentro del bucle contra Trabajadores de la misma labor.
        a_noct = 0.0
    ...
    cantidades_batch = []
    if tab == 'rendimiento':
        for p in re.split(r'[,;\s]+', request.form.get('cantidades_avance') or ''):
            if not str(p).strip():
                continue
            try:
                cantidades_batch.append(float(str(p).replace(',', '.')))
            except Exception:
                cantidades_batch.append(cantidad)
    ok = 0; no_encontrados = []
    for idx, dni in enumerate(dnis):
        cantidad_item = cantidad
        if tab == 'rendimiento' and idx < len(cantidades_batch):
            cantidad_item = cantidades_batch[idx]
        ...
        if tab == 'rendimiento':
            execute('INSERT INTO lecturas_balde(hoja_id,labor_id,dni,trabajador,fecha_hora,a_diurno,a_noct,metodo,registrado_por) VALUES(?,?,?,?,?,?,?,?,?)',
                    (hoja_id,labor_id,dni,t.get('trabajador',''),now_str(),cantidad_item,a_noct,metodo,session.get('usuario')), commit=True)
            ok += 1
            continue
